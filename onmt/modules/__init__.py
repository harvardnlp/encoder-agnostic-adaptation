...
from onmt.modules.multi_headed_attn import MultiHeadedAttention, JointMultiHeadedAttention
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate",
           ...
           "WeightNormConv2d", "AverageAttention", "JointMultiHeadedAttention",
           "SimpleFusionGenerator", "MLP"]
